...
const overrides = [
  addWebpackAlias({
    ...
    '@obsidians/contract': `@obsidians/${process.env.PROJECT}-contract`,
  ...
  overrideProcessEnv({
    ...
    CHAIN_SHORT_NAME: '"Chainmaker"',
    CHAIN_EXECUTABLE_NAME: '"Chainmaker"',
    CHAIN_EXECUTABLE_NAME_IN_LABEL: '"Chainmaker"',
    COMPILER_NAME: '"Solidity Compilier"',
    COMPILER_NAME_IN_LABEL: '"Solidity Compilier"',
    COMPILER_EXECUTABLE_NAME: '"truffle"',
    COMPILER_VERSION_KEY: '"truffle"',
    DOCKER_IMAGE_NODE: '"chainmakerofficial/chainmaker"',
    DOCKER_IMAGE_COMPILER: '"chainmakerofficial/chainmaker-solidity-contract"',
