...
import { ProjectList } from '@obsidians/user';
...
const { PROJECT_GITHUB_REPO } = process.env;
...
class UserHomepage extends PureComponent {
  ...
  isSelf = () => {
    ...
    return (
      platform.isDesktop || match.params.username === profile.get('username')
    );
  };
